...
on many embedded devices, both Linux based and Android based we need to control low level functions on the embedded board form a PC
this software allows exactlly that, the server installed on the embedded device and runs as a deamon, while the send software runs on the PC
